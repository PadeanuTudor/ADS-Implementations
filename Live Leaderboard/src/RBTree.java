...
public class RBTree {
    ...
    public void inorder(Node node, ArrayList<Integer> list,ArrayList<String> listNames){
        if (node == nully)
            return;
        inorder(node.left, list,listNames);
        list.add(node.nr);
        listNames.add(node.name);
        inorder(node.right, list,listNames);
    }

    public boolean check(Node node, String name)
    {
        if (node == nully)
            return false;
        ...
        if(node.name.equals(name))
            return true;
        boolean left = check(node.left,name);
        if(left == true)
            return true;
        return check(node.right,name);
    }
    public Node checky(Node node, String name)
    {
        if (node == nully)
            return null;
        ...
        if(node.name.equals(name))
            return node;
        Node left = checky(node.left,name);
        if(left != null)
            return left;
        return checky(node.right,name);
    }
    ...
    public void insert(int nr, String name)
    {
        Node node = new Node(nr);
        node.name = name;
        node.left = nully;
